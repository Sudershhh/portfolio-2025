  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full"
      >
        <Card className="bg-zinc-900 border-[rgba(204,204,204,0.1)] rounded-3xl overflow-hidden px-11 py-14 text-white h-116 relative flex flex-row gap-12">
          {/* Glow Effect */}
          <div
            className="absolute aspect-square -bottom-[45px] -right-[1px] -top-[45px] w-[591px] overflow-hidden z-0"
            style={{
          ...
          <div className="flex-1 flex items-center justify-center min-w-0">
            <div className="rounded-lg overflow-hidden w-full  min-h-[200px] flex justify-center ">
              {loadedImage ? (
                <img
                  ref={imageRef}
