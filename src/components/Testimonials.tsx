import vaneckLogo from "@/assets/Vaneck.svg";
import oneCommunityLogo from "@/assets/One-Community.svg";

function Testimonials() {
  return (
    <div className="flex flex-col items-center justify-center py-10 mt-36 px-4">
      <div className="max-w-7xl w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col items-center gap-6 p-6">
            ...
            >
              <g transform="translate(-145 -3405)">
                ...
                <path d="M226.23 3442.8c1.05-.05 3.15-.3 3.83-.55 1.26-.46 1.62-1.38 1.62-2.5v-25.95c0-1.12-.36-2.08-1.62-2.59-1.2-.56-2.68-.76-3.62-.86v-1.12h17.3c7.35 0 19.72 3.66 19.72 17.57 0 11.84-10.43 17.12-20.76 17.12h-16.47zm29.26-16.05c0-9.24-4.98-16-12.85-16-1.1 0-2.93.05-3.98.1v27.9c.16 2.38 1.62 3.65 5.03 3.65 8.23 0 11.8-6.5 11.8-15.65z"></path>
                <path d="M264.67 3442.06a7.3 7.3 0 0 0 2.18-.4c.97-.31 1.33-1.12 1.33-2.24v-14.76a3.63 3.63 0 0 0-1.33-2.7 5.58 5.58 0 0 0-2.54-.8v-.97l9.36-.6.36.35v3.45h.1c2.14-2.74 4.48-4.01 6.77-4.01a3.7 3.7 0 0 1 3.72 3.75c0 2.03-1.22 3.7-3.2 3.7-1.9 0-3.22-.9-3.22-2.78 0-.71.41-1.32.46-1.98-2.39 0-4.07 1.98-4.63 2.9v14.2c0 1.11.51 1.92 1.38 2.28.86.35 2.49.56 3.35.6v1.02h-14.1z"></path>
                <path d="M284.62 3431.08c0-6.1 4.08-11.7 11.36-11.7 7.44 0 10.12 4.52 10.12 9.59v.54h-15.08v.54c0 6.1 2.07 10.52 7.39 10.52 3.61 0 5.32-1.23 7.23-4.43l.98.64a11.34 11.34 0 0 1-10.17 6.3c-8.11 0-11.83-5.41-11.83-12zm15.13-2.9c0-3.64-.46-7.62-3.98-7.62-2.84 0-4.6 2.95-4.75 7.72z"></path>
                <path d="M323.86 3423.74c.25-.35.46-.8.46-1.1 0-.7-2.16-1.26-2.83-1.4v-1.01h9v.95c-2.52.7-4.06 1.9-4.99 2.96-.67.75-2.82 3.4-4.73 5.7 2 2.87 5.55 8.43 6.48 9.68 1.08 1.45 1.75 2.15 3.9 2.5v1.06h-12.48v-1.06c1.23-.1 2.72-.45 2.72-1 0-.25-.3-.85-.62-1.35-1.49-2.46-2.67-4.1-3.95-6.06-1.39 1.6-3.6 4.46-4.68 5.96-.26.35-.4.8-.4 1.1 0 .7 2.35 1.25 3.02 1.4v1h-8.99v-.95c2.52-.7 3.8-1.9 4.73-2.95.72-.8 3.5-4.21 5.55-6.67-1.24-1.75-4.22-6.16-6.12-8.96-1.33-1.96-2.62-2.26-3.75-2.26v-1.05h12.03v1.05c-1.03 0-2.42.3-2.42.7 0 .3.2.65.46 1.1.36.66 2 3.21 3.75 5.72 1.29-1.56 2.88-3.71 3.86-5.06"></path>
                <path d="M330.31 3431.08c0-6.1 4.08-11.7 11.36-11.7 7.44 0 10.12 4.52 10.12 9.59v.54h-15.08v.54c0 6.1 2.07 10.52 7.39 10.52 3.61 0 5.32-1.23 7.23-4.43l.98.64a11.34 11.34 0 0 1-10.17 6.3c-8.11 0-11.83-5.41-11.83-12zm15.13-2.9c0-3.64-.46-7.62-3.98-7.62-2.84 0-4.6 2.95-4.75 7.72z"></path>
                <path d="M352 3442.64c.84-.06 1.48-.16 2.13-.42.94-.3 1.34-1.14 1.34-2.27v-29.27c-.05-1.25-.55-2.44-1.34-3-.6-.42-2.59-.94-3.48-.99v-1.03l10.14-.57.35.36v34.19c0 1.13.44 1.96 1.34 2.38.74.3 1.29.51 2.18.62v1.03H352z"></path>
                ...
                <path d="M247.64 3451.4v6.07c0 1.33.2 2.05.55 2.36.28.24 1.31.52 1.6.55v.38h-4.81v-.38a5.05 5.05 0 0 0 1.5-.46c.38-.3.52-1.04.52-2.36v-6.03c0-.52-.16-1.03-.5-1.36a3.78 3.78 0 0 0-1.65-.77v-.4h3.67l6.38 8.56v-5.3c0-1.28-.2-2.07-.55-2.35-.3-.22-1.28-.5-1.6-.53v-.38h4.8v.38c-.28.03-1.18.2-1.5.45-.4.29-.53 1.12-.53 2.32v8.7h-.83z"></path>
                <path d="M260.92 3460.46c.31-.01 1.03-.1 1.26-.19.42-.15.54-.45.54-.83v-8.9c0-.38-.12-.66-.54-.83a6.4 6.4 0 0 0-1.26-.33v-.38h5.92v.38c-.31.04-.96.14-1.27.24-.42.14-.53.46-.53.84v8.9c0 .38.14.65.53.83.2.08.96.24 1.27.27v.39h-5.92z"></path>
                <path d="M271.28 3450.65a1.57 1.57 0 0 0-.76-.95c-.31-.17-.76-.3-1.14-.32v-.38h5.82v.38c-.95.1-1.64.29-1.64.63 0 .12.03.3.09.43.18.57 1.67 4.78 2.72 7.68.78-1.82 1.87-4.47 2.2-5.33.46-1.2.8-1.97.8-2.54 0-.51-1.11-.8-1.96-.86v-.39h4.66v.4a3 3 0 0 0-1.12.32c-.48.3-.7.79-.97 1.35l-4.1 9.78h-.92l-3.68-10.2"></path>
                <path d="M283.77 3460.46c.32-.03 1.13-.12 1.38-.22.43-.16.55-.45.55-.85v-8.83c0-.38-.1-.68-.55-.85a6.92 6.92 0 0 0-1.38-.33v-.38h10.06v2.88h-.48c-.21-.78-1.15-2.19-1.98-2.3-.43-.06-.9-.08-1.45-.08h-1.86v4.95h1.32c.98 0 1.3-.3 1.53-.52.3-.3.55-1.17.6-1.62h.48v4.88h-.48a4.05 4.05 0 0 0-.6-1.7c-.25-.26-.59-.52-1.53-.52h-1.32v3.83c0 1.35.3 1.53 2 1.53 1.11 0 2.32.01 2.74-.4.62-.61 1.31-2 1.53-2.55h.44l-.23 3.47h-10.77z"></path>
                <path d="M305.34 3458c-.18-1.6-.52-2.96-2.25-2.96h-.97v4.17c0 .37.12.68.5.83.22.09.9.2 1.2.24v.38h-5.67v-.38c.3-.01 1.02-.12 1.23-.2.4-.16.52-.46.52-.86v-8.72c0-.37-.1-.7-.52-.85-.3-.12-.93-.24-1.23-.27v-.38h5.96c2.1 0 3.9.79 3.9 2.65 0 1.86-1.72 2.64-3.07 3.02v.13c.82.1 2.14.53 2.47 1.78.25.94.33 1.67.53 2.5.17.66.52.8.8.8.42 0 .79-.5.79-1.56v-.36h.47l-.02.38c-.02 1.5-.62 2.5-2.29 2.5-1.4 0-2.1-.81-2.35-2.84zm-2.53-3.48c1.46 0 2.71-.6 2.71-2.55 0-1.86-1.01-2.47-2.35-2.47h-1.05v5.02z"></path>
                <path d="M314.51 3460l-.51.76h-.53l-.09-4.02h.37c.6 1.7 1.72 3.57 3.51 3.57 1.29 0 1.96-.86 1.96-2.06 0-1-.56-1.68-1.6-2.1-.77-.31-1.4-.54-2.1-.86-1.26-.58-1.86-1.63-1.86-3.08 0-1.78 1.31-3.21 3.33-3.21.96 0 1.9.4 2.44.8l.47-.72h.54l.06 3.86h-.36c-.7-2.08-1.6-3.4-3.22-3.4-.77 0-1.57.6-1.57 1.76 0 1 .5 1.58 1.5 2.06.72.35 1.45.58 2.06.86 1.26.6 2.09 1.35 2.09 3.12 0 2.03-1.54 3.5-3.72 3.5a4.48 4.48 0 0 1-2.77-.84"></path>
                <path d="M326.08 3460.46c.31-.01 1.03-.1 1.26-.19.42-.15.54-.45.54-.83v-8.9c0-.38-.12-.66-.54-.83-.32-.12-.93-.3-1.26-.33v-.38H332v.38a8.3 8.3 0 0 0-1.27.24c-.42.14-.53.46-.53.84v8.9c0 .38.14.65.53.83.2.08.96.24 1.27.27v.39h-5.92z"></path>
                <path d="M338.59 3460.46c.32-.01 1.2-.13 1.42-.22.43-.16.55-.49.55-.87v-9.87h-.62c-.4 0-.95.02-1.35.07-.76.1-1.7 1.77-1.92 2.53h-.44v-3.1h11v3.1h-.44c-.21-.76-1.16-2.42-1.92-2.53-.4-.05-.9-.07-1.35-.07h-.62v9.79c0 .38.14.69.55.86.2.09 1.1.28 1.42.31v.39h-6.28z"></path>
            ...
            <p className="text-lg md:text-xl text-zinc-200 italic text-center">
              {/* "Super fun to work with and had a fun time collaborating together" */}
              "Sri is super easy to work with and just a fun, relaxed person to
              have on the team, we had a great time collaborating together!"
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-6 p-6">
            ...
            <div className="text-zinc-200">
              <p className="text-lg md:text-xl italic text-center mb-4">
                "Led the revamp of our Asset Tokenization platform, implementing
                Redux and crypto wallet integrations. His technical expertise
                and innovative solutions significantly enhanced platform
                performance."
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-6 p-6">
            ...
            <div className="text-zinc-200">
              <p className="text-lg md:text-xl italic text-center mb-4">
                "Quick learner, integrates feedback well and an overall joy to
                work with. His commitment extended beyond his tenure, showcasing
